...
describe('PF-4.5 Altura negativa', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-4.5 Altura negativa', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1050, height: 565 })
    ...
    await driver.findElement(By.css("div:nth-child(2) > input")).sendKeys("-1")
