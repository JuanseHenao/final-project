...
describe('PF-4.2 No altura', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-4.2 No altura', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1109, height: 625 })
    await driver.findElement(By.css("a:nth-child(5) > button")).click()
    {
      const element = await driver.findElement(By.css("a:nth-child(5) > button"))
