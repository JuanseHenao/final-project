...
describe('PF-1.4 Cantidad aceptada', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-1.4 Cantidad aceptada', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1058, height: 574 })
    ...
    {
      const element = await driver.findElement(By.css(".numsC"))
