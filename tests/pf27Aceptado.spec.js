...
describe('PF-2.7 Aceptado', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-2.7 Aceptado', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1085, height: 601 })
    ...
    await driver.findElement(By.css("div:nth-child(3) > input")).sendKeys("7")
