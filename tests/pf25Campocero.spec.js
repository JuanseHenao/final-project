...
describe('PF-2.5 Campo cero', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-2.5 Campo cero', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1077, height: 593 })
    ...
    await driver.findElement(By.css("div:nth-child(3) > input")).sendKeys("3")
