...
describe('PF-4.7 Caso aceptado', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PF-4.7 Caso aceptado', async function() {
    await driver.get("https://finalprojectjuansehenao.herokuapp.com/")
    await driver.manage().window().setRect({ width: 1058, height: 573 })
    ...
    await driver.findElement(By.css("div:nth-child(2) > input")).sendKeys("7")
